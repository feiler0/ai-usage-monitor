...
![AI Usage Monitor preview](docs/images/screenshot.png)
...
- DeepSeek 余额来自官方接口，标题右侧显示余额和 `实时`
- Reasonix 会话比账单更新时，在账单行时间后显示 `未落账`
...
详细说明见 [docs/data-sources.md](docs/data-sources.md)。隐私说明见 [docs/privacy.md](docs/privacy.md)。
...
- `未落账` 只表示 Reasonix 会话文件比账单文件更新，不代表会话费用或 Token 已经可计算。
